package com.jungmook.blog.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (token != null && !token.equalsIgnoreCase("null")) {
                // 토큰을 검증해서 payloaddml userEmail을 가져온다.
                ...
                // SecurityContext에 AbstractAuthenticationToken 객체를 추가해서 해당 Thread가 지속적으로 인증 정보를 가질 수 있도록 해줌
